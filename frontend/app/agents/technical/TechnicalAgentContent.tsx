...
export default function TechnicalAgentDashboard() {
  ...
  /* ---------------- EMPTY STATE ---------------- */
  if (!rfpData?.technical_analysis?.items?.length) {
    return (
            ...
            <table className="table">
              <thead>
                <tr>
                  ...
                  <th className="w-3/12">RECOMMENDED SKU</th>
                  <th className="w-2/12">MATCH %</th>
                ...
                {items.map((item: any) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-semibold ${item.final_match_percent === 100
